...
import { useConnectOtdr, useGetOtdrConnectionStatus, useRunSkippyMetricsWithImage } from "@/hooks/use-otdr"
...
export default function UserDashboard() {
  ...
  return (
    <div className="mx-auto grid w-full max-w-full gap-6 p-6 lg:grid-cols-2">
      <Card>
        <CardHeader>
          <CardTitle>Image Source</CardTitle>
          <CardDescription>
            Test images are captured by the backend from your local Python image server.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="rounded-md border bg-muted/20 p-4 text-sm leading-6">
            ...
            <p>Disabled. No client-side camera stream or image preview is used.</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage OTDR connection and trigger future testing workflow.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            <Button disabled={connectOtdr.isPending} onClick={handleConnect} type="button">
              Connect OTDR
            </Button>
            <Button disabled={connectOtdr.isPending} onClick={handleDisconnect} type="button" variant="destructive">
              Disconnect OTDR
            </Button>
          </div>
          ...
          <Button
            ...
            variant="secondary"
          >
            {runSkippyMetricsWithImage.isPending ? "Testing..." : "Start Testing"}
          </Button>
          ...
          {runSkippyMetricsWithImage.data ? (
            <div className="space-y-2">
              ...
              <pre className="max-h-135 overflow-auto rounded-md border bg-muted/20 p-3 text-xs leading-5">
